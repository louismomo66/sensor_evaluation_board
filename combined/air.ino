...
String air1string(){
  ...
  if (pms1) {
   ...
   String one = "PM 1.0: " + String(pms1.pm01);
    String two = "PM 2.5: " + String(pms1.pm25);
    String three = "PM 10: " + String(pms1.pm10);
...
String air2string(){
  ...
  pms2.read();
    if (pms2) {
   String one1 = "PM 1.0: " + String(pms2.pm01);
    String two2 = "PM 2.5: " + String(pms2.pm25);
    String three3 = "PM 10: " + String(pms2.pm10);
...
String air3string(){
  ...
  pms3.read();
    if (pms3) {
    // reading data was successful!
 String one11 = "PM 1.0: " + String(pms3.pm01);
    String two22 = "PM 2.5: " + String(pms3.pm25);
    String three33 = "PM 10: " + String(pms3.pm10);
